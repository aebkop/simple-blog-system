...
public class PostsServiceVertxEBProxy implements PostsService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public PostsServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public PostsServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void getPost(String id, Handler<AsyncResult<JsonObject>> handler){
    ...
    _deliveryOptions.addHeader("action", "getPost");
  ...
  public void getPosts(Handler<AsyncResult<JsonObject>> handler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getPosts");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
